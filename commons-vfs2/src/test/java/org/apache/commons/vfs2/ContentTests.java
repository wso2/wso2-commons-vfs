...
public class ContentTests extends AbstractProviderTestCase {
    ...
    public void testChildren() throws FileSystemException {
        ...
        try {
            ...
            VfsTestUtils.assertSameMessage("vfs.provider/list-children-not-folder.error", file, e);
        }
    ...
    public void testUnknownContent() throws Exception {
        ...
        try {
            ...
            VfsTestUtils.assertSameMessage("vfs.provider/read-not-file.error", unknownFile, e);
        }
        try {
            content.getSize();
            fail();
        } catch (final FileSystemException e) {
            VfsTestUtils.assertSameMessage("vfs.provider/get-size-not-file.error", unknownFile, e);
        }
    }
