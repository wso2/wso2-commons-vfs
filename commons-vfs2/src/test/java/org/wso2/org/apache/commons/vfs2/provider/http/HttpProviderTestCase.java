 ...
 */
package org.wso2.org.apache.commons.vfs2.provider.http;

import static org.wso2.org.apache.commons.vfs2.VfsTestUtils.getTestDirectory;
...
import org.wso2.org.apache.commons.vfs2.util.NHttpFileServer;
...
public class HttpProviderTestCase extends AbstractProviderTestConfig {
    ...
    private static void setUpClass() throws Exception {
        ...
        connectionUri = getLocalHostUriString("http", server.getPort());
    }
    ...
    public void ignoreTestHttp405() throws FileSystemException {
        try (FileObject fileObject = VFS.getManager()
            ...
            Assertions.assertTrue(fileObject.getContent().getSize() > 0, "Content size should be > 0");
