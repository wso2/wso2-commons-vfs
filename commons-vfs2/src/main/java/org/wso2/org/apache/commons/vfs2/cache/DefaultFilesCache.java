 ...
 */
package org.wso2.org.apache.commons.vfs2.cache;
...
/**
 * A simple {@link FilesCache FilesCache} implementation.
 * <p>
 ...
 * {@link FileSystemManager FileSystemManager} is closed, it will also {@linkplain #close()
 * close} this cache (which frees all entries).
 * </p>
 * <p>
 * Despite its name, this is not the fallback implementation used by
 * {@link DefaultFileSystemManager#init() DefaultFileSystemManager#init()} anymore.
 * </p>
 */
