...
public final class FtpsFileSystemConfigBuilder extends FileSystemConfigBuilder
{
    ...
    private static final String KEY_STORE =
            FtpsFileSystemConfigBuilder.class.getName() + ".KEY_STORE";
    private static final String TRUST_STORE =
            FtpsFileSystemConfigBuilder.class.getName() + ".TRUST_STORE";
    private static final String KS_PASSWD =
            FtpsFileSystemConfigBuilder.class.getName() + ".KS_PASSWD";
    private static final String TS_PASSWD =
            FtpsFileSystemConfigBuilder.class.getName() + ".KS_PASSWD";
    private static final String KEY_PASSWD =
            FtpsFileSystemConfigBuilder.class.getName() + ".KEY_PASSWD";
